    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function define_routes() {
                ...
                Routing.map("#B").to(function() {
                    update("B[action]");
                });

                Routing.map("#B").before(function() {
                    update("B[before]");
                });

                Routing.map("#C").to(function() {
                    update("C[action]");
                }).leaving(function() {
                    update("C[leaving]");
                });
                ...
                Routing.map("#H(/:id_one)(/:id_two)").to(function () {
